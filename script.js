...
const estados = [
    // NORTE
    { sigla: 'AC', nome: 'Acre', regiao: 'Norte', cor: '#2E7D32', x: 372, y: 418 },
    { sigla: 'AM', nome: 'Amazonas', regiao: 'Norte', cor: '#2E7D32', x: 508, y: 259 },
    { sigla: 'PA', nome: 'Pará', regiao: 'Norte', cor: '#2E7D32', x: 756, y: 126 },
    { sigla: 'RO', nome: 'Rondônia', regiao: 'Norte', cor: '#2E7D32', x: 459, y: 352 },
    { sigla: 'RR', nome: 'Roraima', regiao: 'Norte', cor: '#2E7D32', x: 583, y: 99 },
    { sigla: 'TO', nome: 'Tocantins', regiao: 'Norte', cor: '#2E7D32', x: 682, y: 259 },
    { sigla: 'AP', nome: 'Amapá', regiao: 'Norte', cor: '#2E7D32', x: 881, y: 59 },
    
    // NORDESTE
    { sigla: 'MA', nome: 'Maranhão', regiao: 'Nordeste', cor: '#F57C00', x: 794, y: 179 },
    { sigla: 'PI', nome: 'Piauí', regiao: 'Nordeste', cor: '#F57C00', x: 769, y: 286 },
    { sigla: 'CE', nome: 'Ceará', regiao: 'Nordeste', cor: '#F57C00', x: 931, y: 152 },
    { sigla: 'RN', nome: 'Rio Grande do Norte', regiao: 'Nordeste', cor: '#F57C00', x: 1018, y: 192 },
    { sigla: 'PB', nome: 'Paraíba', regiao: 'Nordeste', cor: '#F57C00', x: 1018, y: 259 },
    { sigla: 'PE', nome: 'Pernambuco', regiao: 'Nordeste', cor: '#F57C00', x: 968, y: 312 },
    { sigla: 'AL', nome: 'Alagoas', regiao: 'Nordeste', cor: '#F57C00', x: 993, y: 365 },
    { sigla: 'SE', nome: 'Sergipe', regiao: 'Nordeste', cor: '#F57C00', x: 944, y: 418 },
    { sigla: 'BA', nome: 'Bahia', regiao: 'Nordeste', cor: '#F57C00', x: 857, y: 445 },
    
    // CENTRO-OESTE
    { sigla: 'MT', nome: 'Mato Grosso', regiao: 'Centro-Oeste', cor: '#FDD835', x: 583, y: 339 },
    { sigla: 'MS', nome: 'Mato Grosso do Sul', regiao: 'Centro-Oeste', cor: '#FDD835', x: 559, y: 485 },
    { sigla: 'GO', nome: 'Goiás', regiao: 'Centro-Oeste', cor: '#FDD835', x: 695, y: 418 },
    { sigla: 'DF', nome: 'Distrito Federal', regiao: 'Centro-Oeste', cor: '#FDD835', x: 683, y: 352 },
    
    // SUDESTE
    { sigla: 'MG', nome: 'Minas Gerais', regiao: 'Sudeste', cor: '#1976D2', x: 782, y: 498 },
    { sigla: 'ES', nome: 'Espírito Santo', regiao: 'Sudeste', cor: '#1976D2', x: 881, y: 511 },
    { sigla: 'RJ', nome: 'Rio de Janeiro', regiao: 'Sudeste', cor: '#1976D2', x: 832, y: 591 },
    { sigla: 'SP', nome: 'São Paulo', regiao: 'Sudeste', cor: '#1976D2', x: 733, y: 591 },
    
    // SUL
    { sigla: 'PR', nome: 'Paraná', regiao: 'Sul', cor: '#C2185B', x: 708, y: 684 },
    { sigla: 'SC', nome: 'Santa Catarina', regiao: 'Sul', cor: '#C2185B', x: 757, y: 764 },
    { sigla: 'RS', nome: 'Rio Grande do Sul', regiao: 'Sul', cor: '#C2185B', x: 658, y: 844 }
];
